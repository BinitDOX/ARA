...
fun ActionMenu(
    ...
    if (overflowActions.isNotEmpty()) {
        IconButton(onClick = { menuVisible.value = true }) {
            Icon(Icons.Default.MoreVert, stringResource(id = R.string.cd_btn_menu))
        }
        DropdownMenu(
...
private fun PreviewActionMenu() {
    val items = listOf(
        ActionItem(R.string.cd_btn_camera, Icons.Default.Camera, OverflowMode.NEVER_OVERFLOW) {},
        ActionItem(R.string.cd_btn_send_message, /* Icons.Default.Send */ null, OverflowMode.IF_NECESSARY) {},
        ActionItem(R.string.cd_btn_back, Icons.Default.ArrowBackIosNew, OverflowMode.IF_NECESSARY) {},
        ActionItem(R.string.cd_btn_camera, Icons.Default.Delete, OverflowMode.IF_NECESSARY) {},
    )
    TopAppBar(
        title = { Text("App bar") },
        navigationIcon = {
